...
class ReferencePointDatabase private constructor(context: Context) {
    ...
    companion object {
        ...
        val availableMapImages = listOf(
            MapImage(R.drawable.se1, "理工一樓"),
            MapImage(R.drawable.se2, "理工二樓"),
            MapImage(R.drawable.se3, "理工三樓"),
            MapImage(R.drawable.sea4, "理工A棟四樓"),
            MapImage(R.drawable.seb4, "理工B棟四樓"),
            MapImage(R.drawable.sec4, "理工C棟四樓"),
            MapImage(R.drawable.sea5, "理工A棟五樓"),
            MapImage(R.drawable.sec5, "理工C棟五樓")
        )
    }
